...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_date', default='/24_02_2024')
    #Folder stored with trained model weights, which are used for transfer learning
    parser.add_argument('--model_date_', default='/24_02_2024')
    parser.add_argument('--pre_train', default=False)
    parser.add_argument('--path_to_model', default='/home/qq44642754/RL_UR5/')
